...
class TrackGraph:
    '''
        Create an interactable graph of tracking results
    '''

    def __init__(self, forward_state, backward_state):
        self.forward_edges = forward_state
        self.backward_edges = backward_state
...
while not done:
    ...
    pygame.draw.circle(
        screen, GREEN, [250, 250], 40, 20)
    pygame.draw.circle(
        screen, BLACK, [250, 250], 40, 10)
